...
class LlamaModel(Model):
    ...
    def prepare_inputs(self, input_ids: torch.Tensor, params: dict) -> torch.Tensor:
        # If inputs_embeds is provided, skip the normal preparation
        #if params.get('inputs_embeds', False):
        #    return input_ids  # In this case, input_ids is actually the inputs_embeds
            
        # Otherwise, proceed with normal preparation
        #print("in llama.py prepare_inputs ")
        #print(input_ids)
        #print("params")
        #print(params)
